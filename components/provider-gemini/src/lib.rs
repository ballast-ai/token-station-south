//! The official Gemini provider component: a wit-bindgen shell
//! around the conformance crate's native reference implementation.
//!
//! Gate ② froze its fixture pack against `GeminiReferenceV1`; this crate
...
impl Guest for Gemini {
    fn metadata() -> AdapterMetadata {
        let reported = GeminiReferenceV1.metadata();
        AdapterMetadata {
            name: reported.name,
